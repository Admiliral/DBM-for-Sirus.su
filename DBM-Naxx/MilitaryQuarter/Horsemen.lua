...
local specWarnMarkOnPlayer	= mod:NewSpecialWarning("SpecialWarningMarkOnPlayer", nil, false)
...
function mod:OnCombatStart(delay)
	DBM:FireCustomEvent("DBM_EncounterStart", 30549, "The Four Horsemen")
	markCounter = 0
end

function mod:OnCombatEnd(wipe)
	DBM:FireCustomEvent("DBM_EncounterEnd", 30549, "The Four Horsemen", wipe)
end
