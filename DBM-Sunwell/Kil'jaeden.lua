...
--		end
	elseif msg == "Phase" then
		self.mod.vb.phase = self.mod.vb.phase + 1
		if self.mod.vb.phase == 3 then
		...
		elseif self.mod.vb.phase == 4 then
		...
		elseif self.mod.vb.phase == 5 then
