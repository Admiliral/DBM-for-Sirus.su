...
L.TranslationBy 			= " Admiiral, Кролик"
...
-- Tab: Generalwarnings
L.Tab_GeneralMessages 		= "Настройка сообщений"
L.CoreMessages				= "Основные параметры сообщения"
L.ShowLoadMessage 			= "Показывать загрузки модов чате"
L.ShowPizzaMessage 			= "Показывать сообщения таймера в кадре чата"
L.CombatMessages			= "Параметры сообщений в бою"
L.ShowEngageMessage 		= "Показывать сообщения о бое в чате"
L.ShowKillMessage 			= "Показывать сообщения об убийстви в чат"
L.ShowWipeMessage 			= "Показывать сообщения о вайпе в чат"
L.ShowRecoveryMessage 		= "Показывать сообщения о восстановлении таймера в чате"
L.WhisperMessages			= "Параметры сообщений 'шепнуть'"
L.AutoRespond 				= "Авто-ответ на шепот во время боя"
L.EnableStatus 				= "Ответить на «статус» шепотом"
L.WhisperStats 				= "Включить убийств/вайпов статистику в ответы шёпотом"
