...
local warnDevastatingStrike		    = mod:NewSpellAnnounce(305134, 3, nil, mod:IsTank() or mod:IsHealer())
local timerDevastatingStrikeCD		= mod:NewCDTimer(30, 305134, nil, mod:IsTank() or mod:IsHealer())
local timerShatteredArmor           = mod:NewTargetTimer(15, 305135, nil, mod:IsTank() or mod:IsHealer())
