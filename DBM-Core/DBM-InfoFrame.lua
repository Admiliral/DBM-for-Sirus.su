...
do
	...
	function initializeDropdown(_, level, menu)
		...
		if level == 1 then
			...
			info = UIDropDownMenu_CreateInfo()
			info.text = DBM_CORE_INFOFRAME_SETCOLS
			info.notCheckable = true
			info.hasArrow = true
			info.keepShownOnClick = true
			info.menuList = "cols"
		...
		elseif level == 2 then
			...
			elseif menu == "cols" then
				...
				info = UIDropDownMenu_CreateInfo()
				info.text = DBM_CORE_INFOFRAME_COLS_TO:format(1)
				info.func = setCols
				info.arg1 = 1
				...
				info = UIDropDownMenu_CreateInfo()
				info.text = DBM_CORE_INFOFRAME_COLS_TO:format(2)
				info.func = setCols
				info.arg1 = 2
				...
				info = UIDropDownMenu_CreateInfo()
				info.text = DBM_CORE_INFOFRAME_COLS_TO:format(3)
				info.func = setCols
				info.arg1 = 3
				...
				info = UIDropDownMenu_CreateInfo()
				info.text = DBM_CORE_INFOFRAME_COLS_TO:format(4)
				info.func = setCols
				info.arg1 = 4
				...
				info = UIDropDownMenu_CreateInfo()
				info.text = DBM_CORE_INFOFRAME_COLS_TO:format(5)
				info.func = setCols
				info.arg1 = 5
