...
DBM = {
	Revision = parseCurseDate("20220317151100"),
	DisplayVersion = "5.54.7", -- the string that is shown as version
	ReleaseRevision = releaseDate(2022, 03, 17) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
