...
DBM = {
	Revision = parseCurseDate("20210803212300"),
	DisplayVersion = "5.50", -- the string that is shown as version
	ReleaseRevision = releaseDate(2021, 08, 03) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
