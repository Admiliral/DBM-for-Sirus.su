...
DBM = {
	Revision = parseCurseDate("20200426104400"),
	DisplayVersion = "5.40", -- the string that is shown as version
	ReleaseRevision = releaseDate(2020, 4, 26) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
