...
DBM = {
	Revision = parseCurseDate("20220515173200"),
	DisplayVersion = "5.54.10", -- the string that is shown as version
	ReleaseRevision = releaseDate(2022, 05, 17) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
