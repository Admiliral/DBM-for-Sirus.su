...
DBM = {
	Revision = parseCurseDate("20220303113600"),
	DisplayVersion = "5.54.6", -- the string that is shown as version
	ReleaseRevision = releaseDate(2022, 03, 03) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
