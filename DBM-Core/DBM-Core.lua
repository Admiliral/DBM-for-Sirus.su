...
DBM = {
	Revision = parseCurseDate("20210905235400"),
	DisplayVersion = "5.51", -- the string that is shown as version
	ReleaseRevision = releaseDate(2021, 09, 05) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
